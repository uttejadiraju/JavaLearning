...
public class NeedForOverridingMethods {
	private final char first;
	private final char second;

	public NeedForOverridingMethods(char first, char second) {
		this.first = first;
		this.second = second;
	}

	public boolean equals(NeedForOverridingMethods b) {
	...
	public static void main(String[] args) {
		Set<NeedForOverridingMethods> s = new HashSet<>();
		for (int i = 0; i < 10; i++)
			for (char ch = 'a'; ch <= 'z'; ch++)
				s.add(new NeedForOverridingMethods(ch, ch));
